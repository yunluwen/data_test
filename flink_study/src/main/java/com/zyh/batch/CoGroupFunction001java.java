...
public class CoGroupFunction001java {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataSet<Tuple4<String,String,String,String>> text2 = authors
                .coGroup(posts).where(1).equalTo(1)
                .with(new CoGroupFunction<Tuple3<String,String,String>,
                        Tuple2<String,String>, Tuple4<String,String,String,String>>() {
                    @Override
                    public void coGroup(Iterable<Tuple3<String, String, String>> authors,
                                        Iterable<Tuple2<String, String>> posts,
                                        Collector<Tuple4<String, String, String, String>> collector) {
                        //取出Author信息
                        ...
                        //重新组装并发送AuthorPost信息
                        collector.collect(new Tuple4<String, String, String, String>(pt.f0, at.f0, at.f1, at.f2));
                    }
                });
