...
object JSONDataSource {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 创建学生成绩DataFrame
    val studentScoresDF = sqlContext.read.json("hdfs://localhost:9000/spark-study/students.json")
    ...
    //这里出现问题
//            .join(goodStudentInfosDF.rdd.map { row => (row.getAs[String]("name")
//              , row.getAs[Long]("age")) })
...
//    goodStudentsDF.write.format("json").save("hdfs://localhost:9000/spark-study/good-students-scala")
  }
